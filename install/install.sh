...
run_step "Setup dotfiles" "${INSTALL_DIR}/setup-dotfiles.sh"
run_step "Setup XDG directories" "${INSTALL_DIR}/setup-xdg-dirs.sh"
...
# Run this manually - it requires 1Password setup
